...
### Про проект
Ідея та модель розповсюджується "з відкритим кодом" - будь-хто може використати їх. 
...
- LeanStack / Loomio - стати учасником проекту
